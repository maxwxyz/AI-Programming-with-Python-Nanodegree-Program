#!/bin/sh
# */AIPND-revision/intropyproject-classify-pet-images/run_models_batch_uploaded.bat
#                                                                             
...
#
# Usage: sh run_models_batch_uploaded.bat    -- will run program from commandline within Project Workspace
#  
