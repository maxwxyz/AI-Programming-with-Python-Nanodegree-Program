...
#                                                                             
# PROGRAMMER: Maximilian Wilfinger
# DATE CREATED: 8/8/21
# REVISED DATE: 
...
{} % Correct Breed\n\
{} % Correct \"Not-a\" Dog\n\
{} % Match".format(results_stats_dic["pct_correct_dogs"], round(results_stats_dic["pct_correct_breed"],1), results_stats_dic["pct_correct_notdogs"], round(results_stats_dic["pct_match"],1)))
